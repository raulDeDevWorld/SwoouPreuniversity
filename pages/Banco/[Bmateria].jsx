                            ...
                            {bank[router.query.Bmateria.toLowerCase()].map((item, index) =>
                                <div key={index} className={style.itemBox}>
                                    <li className={style.ask} onClick={() => modalHandler(item, index)}>
                                        ...
                                        <span className={style.number}>{`${index + 1}-${userDB.subjects[router.query.Bmateria].progress[item.id] && userDB.subjects[router.query.Bmateria].progress[item.id].difficulty != false ? userDB.subjects[router.query.Bmateria].progress[item.id].difficulty : 'I'})`}{ }</span>{item.pregunta}
                                    </li><br />
