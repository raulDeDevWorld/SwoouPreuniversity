        ...
        <PageSimulacro>
            {userDB !== 'loading' &&
                <div className={style.container}>
                    {simulacro !== null &&
                        <>
                            <span className={style.timer}>{`${userDB.subjects[router.query.Smateria].config.time}:00`}</span>
