...
function Simulacro() {
    ...
    function finish() {
        const oldObject = userDB.subjects[router.query.Smateria].progress
        const newObject = simulacro.reduce((object, item, index) => {
            const newItemObject = {}
            // exit === DB
            const exist = userDB.subjects[router.query.Smateria].progress[simulacro[index].id]
        ...
        userDataUpdate({ ...oldObject, ...newObject }, setUserData, `${router.query.Smateria}/progress`)
    ...
    useEffect(() => {
        ...
        userDB.university !== null && userDB.university !== undefined
            ? getDataForSimulacro(userDB.university, userDB.subjects , router.query.Smateria, userDB.subjects[router.query.Smateria].config.questions, simulacro, setUserSimulacro, bank, setUserBank)
            : ''
